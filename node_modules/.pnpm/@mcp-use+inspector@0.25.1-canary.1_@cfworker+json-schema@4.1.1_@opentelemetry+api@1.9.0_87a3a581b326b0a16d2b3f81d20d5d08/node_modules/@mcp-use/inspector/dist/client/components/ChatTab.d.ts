...
export declare function ChatTab({ connection, isConnected, useClientSide, enableKeyboardShortcuts, prompts, serverId, callPrompt, readResource, chatApiUrl, waitForChatApiUrl, initialMessages, managedLlmConfig, clearButtonLabel, hideTitle, hideModelBadge, hideServerUrl, clearButtonHideIcon, clearButtonHideShortcut, clearButtonVariant, hideClearButton, hideToolSelector, chatQuickQuestions, chatFollowups, }: ChatTabProps): import("react/jsx-runtime").JSX.Element;
export {};
