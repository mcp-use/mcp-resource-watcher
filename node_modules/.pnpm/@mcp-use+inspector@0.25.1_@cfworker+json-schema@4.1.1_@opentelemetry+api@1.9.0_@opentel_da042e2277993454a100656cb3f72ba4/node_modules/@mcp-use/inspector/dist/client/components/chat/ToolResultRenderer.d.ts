 ...
 */
export declare function ToolResultRenderer({ toolName, toolArgs, result, serverId, readResource, toolMeta, onSendFollowUp, serverBaseUrl, partialToolArgs, cancelled, }: ToolResultRendererProps): import("react/jsx-runtime").JSX.Element | null;
export {};
//# sourceMappingURL=ToolResultRenderer.d.ts.map