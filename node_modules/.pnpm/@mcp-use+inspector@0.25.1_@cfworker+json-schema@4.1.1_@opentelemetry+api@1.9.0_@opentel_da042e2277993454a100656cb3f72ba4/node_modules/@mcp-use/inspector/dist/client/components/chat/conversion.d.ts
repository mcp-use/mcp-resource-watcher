 ...
 */
export declare function convertMessagesToLangChain(messages: Message[]): BaseMessage[];
/**
 ...
 */
export declare const convertPromptResultsToMessages: (results: PromptResult[]) => Message[];
