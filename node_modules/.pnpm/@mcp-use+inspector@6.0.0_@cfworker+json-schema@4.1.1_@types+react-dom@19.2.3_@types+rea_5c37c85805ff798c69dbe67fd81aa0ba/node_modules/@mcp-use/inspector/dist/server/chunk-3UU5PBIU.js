...
function registerStaticRoutes(app, clientDistPath, runtimeConfig) {
  const effectiveConfig = {
    ...
    disableTelemetry: runtimeConfig?.disableTelemetry ?? process.env.MCP_USE_ANONYMIZED_TELEMETRY === "false"
  };
  if (USE_CDN) {
...
function registerStaticRoutesWithDevProxy(app, clientDistPath, runtimeConfig) {
  const distPath = clientDistPath || getClientDistPath();
