...
interface PromptResultDisplayProps {
    ...
    previewMode?: boolean;
    onCopy: (index: number, result: GetPromptResult | {
        error?: string;
        isError?: boolean;
    }) => void;
 ...
 */
export declare function PromptResultDisplay({ results, copiedResult, previewMode: _previewMode, onCopy, onDelete, onFullscreen, onTogglePreview: _onTogglePreview, onMaximize, isMaximized, }: PromptResultDisplayProps): import("react/jsx-runtime").JSX.Element;
export {};
//# sourceMappingURL=PromptResultDisplay.d.ts.map