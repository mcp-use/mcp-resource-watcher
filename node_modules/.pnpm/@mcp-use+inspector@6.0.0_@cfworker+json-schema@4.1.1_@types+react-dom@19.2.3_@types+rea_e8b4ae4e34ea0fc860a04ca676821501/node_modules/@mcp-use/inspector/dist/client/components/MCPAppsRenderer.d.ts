...
declare function MCPAppsRendererBase({ serverId, toolCallId, toolName, toolInput, toolOutput, toolMetadata, invoking, invoked, partialToolInput, resourceUri, readResource, onSendFollowUp, className, displayMode: displayModeProp, onDisplayModeChange, noWrapper, customProps, cancelled, onRerun, onReady, chromeless, }: MCPAppsRendererProps): import("react/jsx-runtime").JSX.Element;
export declare const MCPAppsRenderer: import("react").MemoExoticComponent<typeof MCPAppsRendererBase>;
export {};
//# sourceMappingURL=MCPAppsRenderer.d.ts.map