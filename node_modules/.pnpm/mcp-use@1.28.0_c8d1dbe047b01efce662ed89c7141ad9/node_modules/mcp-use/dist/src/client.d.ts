...
export interface MCPClientOptions {
     ...
     */
    onNotification?: (notification: import("@modelcontextprotocol/sdk/types.js").Notification) => void | Promise<void>;
}
export { BaseCodeExecutor, E2BCodeExecutor, isVMAvailable, VMCodeExecutor, } from "./client/codeExecutor.js";
export { accept, acceptWithDefaults, applyDefaults, cancel, decline, getDefaults, reject, validate, } from "./client/elicitation-helpers.js";
export type { ElicitContent, ElicitValidationResult, } from "./client/elicitation-helpers.js";
