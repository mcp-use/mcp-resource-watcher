import{Et as e,I as t,Lt as n,ct as r,ht as i,mr as a,on as o,rn as s,st as c}from"./index-CvA_pUWm.js";import{A as l,D as u,u as d}from"./function_calling-BxZPUXGE.js";function f(e,t){if(e.function===void 0)return;let n;if(t?.partial)try{n=o(e.function.arguments??`{}`)}catch{return}else try{n=JSON.parse(e.function.arguments)}catch(t){throw new l([`Function "${e.function.name}" arguments:`,``,e.function.arguments,``,`are not valid JSON.`,`Error: ${t.message}`].join(`
