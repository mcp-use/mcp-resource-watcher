 ...
 * ```
 */
export declare function McpClientProvider({ children, mcpServers, defaultCallbackUrl, defaultProxyConfig, defaultAutoProxyFallback, clientInfo, storageProvider, enableRpcLogging, onServerAdded, onServerRemoved, onServerStateChange, onSamplingRequest, onElicitationRequest, }: McpClientProviderProps): React.JSX.Element;
/**
