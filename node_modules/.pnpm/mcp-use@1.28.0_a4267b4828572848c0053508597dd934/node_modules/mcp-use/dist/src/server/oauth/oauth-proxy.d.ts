 ...
 */
export type VerifyToken = (token: string) => Promise<{
 ...
 * ```
 */
export declare function jwksVerifier(config: JwksVerifierConfig): VerifyToken;
/**
 ...
 * ```
 */
export declare function oauthProxy(config: OAuthProxyConfig): OAuthProxy;
