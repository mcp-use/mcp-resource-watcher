 ...
 */
export type OAuthConfig = SupabaseOAuthConfig | Auth0OAuthConfig | ClerkOAuthConfig | KeycloakOAuthConfig | WorkOSOAuthConfig | BetterAuthOAuthConfig | CustomOAuthConfig;
