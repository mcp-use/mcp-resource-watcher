...
var cachedEnvironment2, ScarfEventLogger, Telemetry2, Tel2;
      ...
      _getUserIdFromFilesystem() {
        try {
          ...
          try {
            ...
            try {
              const sessionId = `session-${generateUUID2()}`;
              return sessionId;
            } catch (uuidError) {
          ...
          try {
            return `session-${generateUUID2()}`;
          } catch (uuidError) {
            return `session-${Date.now()}-${secureRandomString2()}`;
          }
        }
      }
  ...
  "src/connectors/base.ts"() {
    ...
    BaseConnector = class {
      ...
      trackConnectorInit(data) {
        ...
        Telemetry2.getInstance().trackConnectorInit({
          connectorType,
          ...data
...
var MCPAgent = class {
  ...
  constructor(options) {
    if (options.agentId) {
      ...
      this.telemetry = Telemetry2.getInstance();
...
var BrowserOAuthClientProvider = class {
  ...
  async prepareAuthorizationUrl(authorizationUrl) {
    ...
    const codeVerifierSnapshot = this.pendingCodeVerifier || localStorage.getItem(this.getKey("code_verifier"));
    const stateData = {
      serverUrlHash: this.serverUrlHash,
      expiry: Date.now() + 1e3 * 60 * 10,
      // State expires in 10 minutes
      codeVerifier: codeVerifierSnapshot || void 0,
...
function McpUseProvider({
  ...
  content = /* @__PURE__ */ import_react8.default.createElement(ThemeProvider, null, content);
  if (autoSize) {
