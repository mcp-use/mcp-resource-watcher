 ...
 * @template HasOAuth - Whether OAuth is configured (affects ctx.auth availability)
 */
export type ReadResourceTemplateCallback<TParams extends Record<string, any> = Record<string, any>, HasOAuth extends boolean = false> = (() => Promise<CallToolResult | ReadResourceResult | TypedCallToolResult<any>>) | ((uri: URL) => Promise<CallToolResult | ReadResourceResult | TypedCallToolResult<any>>) | ((uri: URL, params: TParams) => Promise<CallToolResult | ReadResourceResult | TypedCallToolResult<any>>) | ((uri: URL, params: TParams, ctx: EnhancedResourceContext<HasOAuth>) => Promise<CallToolResult | ReadResourceResult | TypedCallToolResult<any>>);
/**
 ...
 */
export interface ResourceTemplateDefinition<HasOAuth extends boolean = false, TParams extends Record<string, any> = Record<string, any>> {
    name: string;
 ...
 */
export interface FlatResourceTemplateDefinition<HasOAuth extends boolean = false, TParams extends Record<string, any> = Record<string, any>> {
    /**
