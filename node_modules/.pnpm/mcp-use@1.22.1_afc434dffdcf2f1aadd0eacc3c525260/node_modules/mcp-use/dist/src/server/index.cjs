...
var USER_ID_STORAGE_KEY, cachedEnvironment2, Telemetry2, Tel2;
  ...
  "src/client/base.ts"() {
    ...
    BaseMCPClient = class {
      ...
      addServer(name, serverConfig) {
        ...
        Tel2.getInstance().trackClientAddServer(name, serverConfig);
      }
      /**
      ...
      removeServer(name) {
        if (this.config.mcpServers?.[name]) {
          ...
          Tel2.getInstance().trackClientRemoveServer(name);
        }
      }
      /**
    ...
    JSONSchemaToZod = class {
      ...
      static parseObject(schema) {
        ...
        if (!schema.properties && schema.additionalProperties && typeof schema.additionalProperties === "object") {
          ...
          return import_zod4.z.record(import_zod4.z.string(), valueSchema);
        }
        const shape = {};
