...
import type { ReadResourceCallback, ReadResourceTemplateCallback, InferTemplateParams, ResourceDefinition, ResourceTemplateDefinition } from "./types/resource.js";
...
import type { McpMiddlewareEntry, McpMiddlewareFn } from "./middleware/mcp-middleware.js";
/**
 * MCP Server class
 *
...
declare class MCPServerClass<HasOAuth extends boolean = false> {
     ...
     * @internal
     */
    mcpMiddlewares: McpMiddlewareEntry[];
    /**
     ...
     * ```
     */
    proxy(config: Record<string, any> | any, options?: {
        namespace?: string;
    }): Promise<void>;
    /**
     ...
     */
    resourceTemplate: <T extends ResourceTemplateDefinition<HasOAuth, any> | import("./types/index.js").ResourceTemplateDefinitionWithoutCallback | import("./types/index.js").FlatResourceTemplateDefinition<HasOAuth, any> | import("./types/index.js").FlatResourceTemplateDefinitionWithoutCallback>(templateDefinition: T, callback?: ReadResourceTemplateCallback<InferTemplateParams<T>, HasOAuth>) => this;
    /**
...
export type McpServerInstance<HasOAuth extends boolean = false> = WithMcpUse & MCPServerClass<HasOAuth> & HonoType;
