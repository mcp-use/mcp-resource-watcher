...
function registerPrompt(promptDefinition, callback) {
  ...
  const wrappedCallback = /* @__PURE__ */ __name(async (params, extra) => {
    ...
    const { findSessionContext: findSessionContext2, createClientCapabilityChecker: createClientCapabilityChecker2 } = await import("../../tool-execution-helpers-4VX35RCT.js");
...
function registerResourceTemplate(resourceTemplateDefinition, callback) {
  ...
  this.server.registerResource(
    ...
    async (uri) => {
      ...
      const { getRequestContext: getRequestContext2, runWithContext: runWithContext2 } = await import("../../context-storage-NA4MHWOZ.js");
      const { findSessionContext: findSessionContext2 } = await import("../../tool-execution-helpers-4VX35RCT.js");
      const initialRequestContext = getRequestContext2();
      const sessions = this.sessions || /* @__PURE__ */ new Map();
  ...
  async proxy(config, options) {
    ...
    const proxyClient = new MCPClient({
      ...
      onSampling: /* @__PURE__ */ __name(async (params) => {
        try {
          const { getRequestContext: getRequestContext2 } = await import("../../context-storage-NA4MHWOZ.js");
          const { findSessionContext: findSessionContext2 } = await import("../../tool-execution-helpers-4VX35RCT.js");
